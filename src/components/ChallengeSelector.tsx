...
  onUpdateChallengeDuration: (id: string, newDuration: number) => void;
  activeTab: 'active' | 'archived'; // New prop
  onSelectTab: (tab: 'active' | 'archived') => void; // New prop
}
...
          ))
          ...
          <div className="text-gray-500 dark:text-gray-400 text-center w-full">
            {activeTab === 'active' ? 'No active challenges. Create a new one!' : 'No challenges archived yet.'}
          </div>
        )}
      </div>

      {showSettings && activeChallenge && activeTab === 'active' && (
